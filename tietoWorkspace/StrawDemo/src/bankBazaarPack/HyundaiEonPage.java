...
public class HyundaiEonPage
{
	...
	public static void run(WebDriver driver, RecognizerMain OFR) throws InterruptedException, InstantiationException, IOException, PropertyException
	{
		...
		speak.convertToSpeech("What type of fuel does your car run on? You have options petrol, "
				+ "petrol and el pi Gi, petrol and ci en gi ?");
		speak.freeReference();
